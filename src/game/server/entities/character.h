...
public:
	...
	bool TakeDamage(vec2 Force, vec2 Source, int Dmg, int From, int Weapon, int PrevFrom);
...
public:
	...
	void SetHookState(int State) { m_Core.m_HookState = State; }
	void SetHookedPlayer(int Player) { m_Core.m_HookedPlayer = Player; }
