...
void CControls::OnConsoleInit()
{
	...
	Console()->Register("+special", "", CFGFLAG_CLIENT, ConKeyInputState, &m_InputData.m_Special, "Special");
...
int CControls::SnapInput(int *pData)
{
	...
	if (m_pClient->m_pChat->IsActive() || m_pClient->m_pMenus->IsActive() || (m_pClient->m_Snap.m_pLocalCharacter && m_pClient->m_Snap.m_pLocalCharacter->m_Frozen))
	{
		OnReset();
