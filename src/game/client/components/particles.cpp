...
void CParticles::RenderGroup(int Group)
{
	...
	while(i != -1)
	{
		...
		Graphics()->SetColor(
			m_aParticles[i].m_Color.r * (m_aParticles[i].m_FadeOut ? (1 - a) : 1),
			m_aParticles[i].m_Color.g * (m_aParticles[i].m_FadeOut ? (1 - a) : 1),
			m_aParticles[i].m_Color.b * (m_aParticles[i].m_FadeOut ? (1 - a) : 1),
