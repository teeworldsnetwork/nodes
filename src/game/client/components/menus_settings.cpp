...
void CMenus::RenderSettingsControls(CUIRect MainView)
{
	...
	MainView.HSplitTop(Split + 10.0f, &LastExpandRect, &MainView);
	s_ScrollRegion.AddRect(LastExpandRect);
	static int s_NodesDropdown = 0;
	static bool s_NodesActive = true;
	Split = DoIndependentDropdownMenu(&s_NodesDropdown, &MainView, Localize("Nodes"), HeaderHeight, &CMenus::RenderSettingsControlsNodes, &s_NodesActive);
