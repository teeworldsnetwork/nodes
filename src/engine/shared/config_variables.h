...
MACRO_CONFIG_STR(SvName, sv_name, 128, "unnamed nodes server", CFGFLAG_SAVE|CFGFLAG_SERVER, "Server name")
...
MACRO_CONFIG_STR(SvMap, sv_map, 128, "hill", CFGFLAG_SAVE|CFGFLAG_SERVER, "Map to use on the server")
