...
PlayerFlags = Flags("PLAYERFLAG", ["ADMIN", "CHATTING", "SCOREBOARD", "READY", "DEAD", "WATCHING", "BOT", "ILL"])
...
Objects = [
	...
	NetObject("Character:CharacterCore", [
		...
		NetFlag("m_TriggeredEvents", CoreEventFlags),
                ...
                NetIntAny("m_CrateBuff"),
                NetIntAny("m_CrateBuffMisc"),
		NetTick("m_CrateBuffTick"),
	]),
	...
	NetObject("GameDataRace", [
        ...
        NetEvent("WrenchHit:Common", []),

        NetEvent("Effect:Common", [
		NetIntRange("m_ID", 0, 4),
