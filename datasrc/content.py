...
container.sounds.Add(SoundSet("bomb_ticking", ["audio/crt_bomb_ticking.wv"]))
...
image_turrets = Image("turrets", "nodes/buildings/turrets.png")
image_nopower = Image("nopower", "nodes/no_power.png")
image_buildmenu = Image("buildmenu", "nodes/buildmenu.png")
image_fx_ice_expl = Image("fx_ice_expl", "nodes/fx_ice_explosion.png")
image_crate = Image("crate", "nodes/fx_crate.png")
image_helmets = Image("helmets", "nodes/fx_helmets.png")
image_fx_ice = Image("fx_ice", "nodes/fx_ice.png")
image_gui = Image("gui", "nodes/gui.png")
image_fx_bomb = Image("fx_bomb", "nodes/fx_bomb.png")
image_fx_hot = Image("fx_hot", "nodes/fx_hot.png")
image_blocks = Image("blocks", "nodes/blocks.png")
...
container.images.Add(Image("nodes_logo", "nodes/ui/nodes_logo.png"))
...
for i in range(0, len(buildings)):
	...
	for t in range(0,2):
		...
		b_filename = "nodes/buildings/"+bteamnames[t] + "_" + buildings[i][0] + ".png";
